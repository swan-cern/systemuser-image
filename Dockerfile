...
FROM gitlab-registry.cern.ch/swan/docker-images/notebook:v7.0.0
...
RUN pip install --no-deps -i https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple \
            hdfsbrowser==1.0.0 \
